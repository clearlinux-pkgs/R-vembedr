...
Version  : 0.1.4
Release  : 1
URL      : https://cran.r-project.org/src/contrib/vembedr_0.1.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/vembedr_0.1.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613581263
